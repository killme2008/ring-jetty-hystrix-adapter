package cn.leancloud.jetty.handler;
...
// Copied from jetty project(jetty-9.2.10.v20150310)
// Some convenient XXXreset action added.
...
public class StatisticsHandler extends HandlerWrapper implements Graceful {
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.handler.StatisticsHandler.class);
    ...
    // Methods below added by leancloud at 2019-02-20
    @ManagedOperation(impact = "ACTION")
    public void responses1xxReset() {
        _responses1xx.reset();
    }

    @ManagedOperation(impact = "ACTION")
    public void responses2xxReset() {
        _responses2xx.reset();
    }

    @ManagedOperation(impact = "ACTION")
    public void responses3xxReset() {
        _responses3xx.reset();
    }

    @ManagedOperation(impact = "ACTION")
    public void responses4xxReset() {
        _responses4xx.reset();
    }

    @ManagedOperation(impact = "ACTION")
    public void responses5xxReset() {
        _responses5xx.reset();
    }
